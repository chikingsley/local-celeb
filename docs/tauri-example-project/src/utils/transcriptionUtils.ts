import type { Segment, TranscriptionData, Word } from "../types/transcription";
...
export const findWordAtTime = (
	transcription: TranscriptionData,
	time: number
): { segment: Segment; word: Word; wordIndex: number } | null => {
...
export const searchTranscription = (
	transcription: TranscriptionData,
	query: string
): Array<{ segmentId: string; wordIndex: number; match: string }> => {
